...
import com.example.demo.service.impl.oauth2.OAuth2Service;
...
public class DemoApplication {
	...
	public WebSecurityConfigurerAdapter webSecurityConfigurerAdapter() {
		WebSecurityConfigurerAdapter ad = new WebSecurityConfigurerAdapter() {
			@Override
	...
	public AuthorizationServerConfigurer authorizationServerConfigurer(UserDetailsService userDetailsService, 
			ClientDetailsService clientDetailsService,TokenStore tokenStore, 
